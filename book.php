        ...
        <div class="container primary">
            <div class="row text-center">
                ...
                <div class="searchform">
                    <form id="Login" action="delete.php" method="post" name="searchform">
            ...
            <div class="row">
                <div class="book-Form">
                    <form id="bookeep" action="bookinsert.php" method="post" name="book_form">
                        ...
                        <!--input type="image" src="https://png.icons8.com/ios/80/000000/synchronize.png" name=" Reset " id="searchimg " value="Reset"
                                    /-->
                        <input type="submit"  name="insert" id="searchname" value="insert">                    </form>
                </div>
            </div>
        </div>
    </main>
